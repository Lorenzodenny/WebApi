...
{
    public class FilmAzione : Film, IHasRegista
    {
        public string Regista { get; set; }

        public FilmAzione(string titolo, int anno, string genere, string regista) : base(titolo, anno, genere, Tipologia.Azione)
        {
            Regista = regista;
        }
