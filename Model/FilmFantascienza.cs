...
{
    public class FilmFantascienza : Film, IHasRegista
    {
        public string Regista {  get; set; }

        public FilmFantascienza(string titolo, int anno, string genere, string regista) : base(titolo, anno, genere, Tipologia.Fantascienza)
        {
            Regista = regista;
        }
