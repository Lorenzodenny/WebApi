...
{
    public class FilmHorror : Film, IHasRegista
    {
        public string Regista { get; set; }

        public FilmHorror(string titolo, int anno, string genere, string regista) : base(titolo, anno, genere, Tipologia.Horror)
        {
            Regista = regista;
        }
